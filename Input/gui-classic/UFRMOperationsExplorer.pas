...
uses
  ...
  UFileStorage, UWallet, UConst, UTxMultiOperation, UOpTransaction, UOrderedList,
...
begin
  ...
  If Assigned(op) then begin
    ...
    If op.OperationToOperationResume(FSourceNode.Bank.BlocksCount,op,True,op.SignerAccount,opr) then
    begin
